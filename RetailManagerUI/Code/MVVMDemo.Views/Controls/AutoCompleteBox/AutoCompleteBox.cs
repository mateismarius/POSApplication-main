    ...
    public partial class AutoCompleteBox : Control, IUpdateVisualState
    {
        ...
        private static void OnMinimumPopulateDelayPropertyChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            ...
            if (newValue < 0)
            {
                ...
                throw new ArgumentException(string.Format(CultureInfo.InvariantCulture, "", newValue), "value");
            }
        ...
        private static void OnMaxDropDownHeightPropertyChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            ...
            if (newValue < 0)
            {
                ...
                throw new ArgumentException(string.Format(CultureInfo.InvariantCulture, "", e.NewValue), "value");
            }
        ...
        {
            return (item as ComboboxItemDataM).Text.ToLower().Contains(search.ToLower()) || (item as ComboboxItemDataM).Value.ToString().ToLower().Contains(search.ToLower());
        }
